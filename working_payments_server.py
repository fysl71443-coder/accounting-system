...
# -*- coding: utf-8 -*-
"""
خادم المدفوعات العامل مع الطباعة
Working Payments Server with Print
"""
...
# إنشاء التطبيق
app = Flask(__name__)
app.secret_key = 'payments-server-secret-key'
...
def home():
    ...
    <head>
        <meta charset="UTF-8">
        <title>نظام المحاسبة - الرئيسية</title>
...
@login_required
def payments_dues():
    """صفحة المدفوعات والمستحقات مع أزرار الطباعة العاملة"""
    return render_template_string("""
    <!DOCTYPE html>
    <html lang="ar" dir="rtl">
    <head>
    ...
    <body>
        <div class="container">
            ...
            <div class="main-header">
                ...
                <p class="mb-0">نظام إدارة المدفوعات مع أزرار الطباعة العاملة</p>
            </div>
            ...
            <div class="print-section">
                ...
                <!-- مثال لطباعة فواتير محددة -->
                <div class="alert alert-success mt-3">
                    <h6><i class="fas fa-lightbulb me-1"></i> طباعة فواتير محددة:</h6>
                    <div class="row">
                        <div class="col-md-3">
            ...
            <!-- تبويبات النظام -->
            <div class="print-section">
                <h4><i class="fas fa-tabs text-primary me-2"></i>تبويبات النظام:</h4>
...
def print_invoice(invoice_type):
    """طباعة جميع الفواتير من نوع محدد"""
...
if __name__ == '__main__':
    print("🚀 تشغيل خادم المدفوعات مع الطباعة...")
