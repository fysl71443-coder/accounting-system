...
# -*- coding: utf-8 -*-
"""
خادم بسيط مع خانات الخصم
Simple Server with Discount Fields
"""
...
# إنشاء التطبيق
app = Flask(__name__)
app.secret_key = 'discount-server-key'
            ...
            <div class="card">
                ...
                <div class="text-center">
                    ...
                    <a href="/print_invoices/sales" target="_blank" class="btn btn-primary btn-print">
                        <i class="fas fa-shopping-cart"></i> طباعة المبيعات مع الخصم
                    </a>
                    
                    <a href="/print_invoices/purchases" target="_blank" class="btn btn-success btn-print">
                        <i class="fas fa-truck"></i> طباعة المشتريات مع الخصم
                    </a>
                </div>
...
if __name__ == '__main__':
    ...
    print("🖨️ طباعة المبيعات: http://localhost:5000/print_invoices/sales")
    print("🖨️ طباعة المشتريات: http://localhost:5000/print_invoices/purchases")
    print("💰 الميزات الجديدة: خانات الخصم والمجموع الفرعي")
    print("=" * 60)
    ...
    try:
        ...
        print("💡 جرب تشغيل الأمر: python discount_server.py")
